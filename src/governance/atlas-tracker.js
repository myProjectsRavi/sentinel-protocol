...
const ENGINE_TECHNIQUE_MAP = Object.freeze({
  ...
  behavioral_fingerprint: Object.freeze({
    technique_id: 'AML.T0014.000',
    tactic: 'Credential Access',
    name: 'Agent Behavioral Impersonation Signal',
    severity: 'high',
  }),
  threat_intel_mesh: Object.freeze({
    technique_id: 'AML.T0018.000',
    tactic: 'Supply Chain',
    name: 'Threat Intelligence Signature Match',
    severity: 'medium',
  }),
  lfrl: Object.freeze({
    technique_id: 'AML.T0016.000',
    tactic: 'Execution',
    name: 'Firewall Rule Correlation Match',
    severity: 'high',
  }),
  self_healing_immune: Object.freeze({
    technique_id: 'AML.T0043.000',
    tactic: 'Evasion',
    name: 'Adaptive Learned Threat Signature Match',
    severity: 'high',
  }),
